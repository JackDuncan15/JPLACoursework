...
public class Hiragana_Quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Hiragana> RunningList = getIntent().getParcelableArrayListExtra("RunningList");
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (txt_answer.getText().toString().equals(RunningList.get(pointer).getRomaji())){
                    ...
                    txt_kana.setText(RunningList.get(pointer).getKana());
                    txt_answer.setText("");
                    Toast.makeText(Hiragana_Quiz.this, "Correct", Toast.LENGTH_SHORT).show();
                    if (incorrect == false){
                        score++;
                    }
                    incorrect = false;
                    ...
                    Toast.makeText(Hiragana_Quiz.this, "Incorrect", Toast.LENGTH_SHORT).show();
                    incorrect = true;
                }
                txt_score.setText(score + "/" + size);
            }
