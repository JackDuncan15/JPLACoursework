...
public class Katakana_selection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_katakana_selection);
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ArrayList<Katakana> RunningList = new ArrayList<>();
                ...
                for(Katakana h : Katakana.Master_List){
                ...
                Intent intent = new Intent(Katakana_selection.this,Katakana_Quiz.class);
